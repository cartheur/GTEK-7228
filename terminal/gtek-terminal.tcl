...
# gtek-terminal.tcl
#
# Simple serial terminal for the GTEK 7228 on Debian/Linux.
#
# This script was adapted from a more general serial/Tk shell and tuned
# for the current GTEK repo workflow:
# - preferred host adapter: Eminent EM1016 / PL2303 USB-to-RS232
# - preferred link settings: 19200,n,8,1 with XON/XOFF first
# - prompt-driven interaction with a text-oriented serial appliance
#
# Typical usage:
...
namespace eval cmdHistory {
    ...
    variable fileName ".gtek-terminal-history"
